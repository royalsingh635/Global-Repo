...
// ---    Tue Aug 20 12:26:34 IST 2019
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class LovCageVOImpl extends ViewObjectImpl
{
    /**
     * This is the default constructor (do not remove).
     */
    public LovCageVOImpl() {
    }
  ...
  /**
   * Returns the bind variable value for BindCageId.
   * @return bind variable value for BindCageId
   */
  public String getBindCageId()
  {
    return (String) getNamedWhereClauseParam("BindCageId");
  }

  /**
   * Sets <code>value</code> for bind variable BindCageId.
   * @param value value to bind as BindCageId
   */
  public void setBindCageId(String value)
  {
    setNamedWhereClauseParam("BindCageId", value);
  }
  ...
  {
    return (String) getNamedWhereClauseParam("BindType");
  }
